...
class OsChina(object):
    ...
    def post(main, timeout):
        ...
        # 4.使用账号密码登陆
        driver.find_element_by_xpath("/html/body/div[1]/div[1]/div[2]/div/div[1]/div[2]/div[1]/div/div[2]").click()
        driver.find_element_by_name('username').send_keys(account)
        driver.find_element_by_name('password').send_keys(password)
        driver.find_element_by_xpath('/html/body/div[1]/div[1]/div[2]/div/div[1]/div[2]/div[2]/div[2]/div[6]/button').click()
